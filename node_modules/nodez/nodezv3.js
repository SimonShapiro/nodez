...
nodez=function(name,options,template) {
    this.name=name
    this.uuid=guid(),
    this.revision = 1
...
exports["addMetaNode"]=function(options,_CB_) {
    var caseFile={}
    var stateMachine=[]
    stateMachine["Add metaNode"]=function(options,_CB_) {
        data=new nodez(options.name,options)
        ndb.createNode(data,function (err, response, node) {    // ...this is what actually persists.
            if (err) {
...
//  Set the machine running
    stateMachine["Add metaNode"](options,_CB_)
}

exports["addTypedNode"]=function(type,data,_CB_) {
    var nodes=[]
    var caseFile={}
    var stateMachine=[]
    stateMachine["abend"]=function() {
    ...
    stateMachine["Add typed node"]=function(type,data) {
        ...
        ndb.cypherQuery(query,params,function(err, status, results) {
            if(err) {
                ...
                if (r.data.length==1) {
                    data=new nodez(data.name,data,r.data[0][0].data.template)
                    console.log(JSON.stringify(data))
                    caseFile["Type node"]=type
...
exports["addLegalRelationship"]=function(fromNode,name,toNode,template,_CB_) {
    var nodes=[]
    var caseFile={}
    var stateMachine=[]
    stateMachine["abend"]=function() {
...
exports["addTypedRelationship"]=function(fromType,fromNode,name,toType,toNode,rdata,_CB_) {
    var nodes=[]
    var caseFile={}
    var stateMachine=[]
    stateMachine["abend"]=function() {
