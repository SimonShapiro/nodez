...
exports["addAnyNode"]=function(data,_CB_) {
    var nodes=[]
    var caseFile={}
    var stateMachine=[]
    stateMachine["Add any node"]=function(options,_CB_) {
        data=new nodez()
        if(options) {
            for (o in options) {
                data[o]=options[o]
...
//  Set the machine running
    stateMachine["Add any node"](data,_CB_)
}
...
//                console.log(head.addAnyNode.type)
                n.addAnyNode(head.addAnyNode,function(caseFile) {
                    cases.push(caseFile)
                    series(tail)}
                ) 
                break   
